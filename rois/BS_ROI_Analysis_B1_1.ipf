...
//				end
			"-"
			Submenu "Remove ROI"
				wave2list("Root:CurrentROIs:All_ROI_list"), /q, RemovetheROI()
			end
			...
			Submenu "Change color of ROI "
				wave2list("Root:CurrentROIs:All_ROI_list"), /q, ROICOLOR()
			End
		End
		SubMenu "Image"
		"Autoscale", /q, BS_autoscale()
		"-"
...
static function ROI(Image, ROIorBROI)
 	wave Image
 	string ROIorBROI
...
Static Function /S Wave2List( wName )
	String wName // wave name
